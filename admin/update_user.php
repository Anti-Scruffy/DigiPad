    ...
    <div class="container-fluid">
     ...
     <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       ...
       <form class="form-signin" method="post" id="register-form" style="width:30%;margin-left:auto;margin-right:auto;">
        ...
        <input type="text" class="form-control" placeholder="Username" name="username" id="username" required value="<?php $query= mysqli_query($DBcon, "SELECT * FROM tbl_user WHERE user_id= ''");$row= mysqli_fetch_array($query); ?><?= $row['username'];?>"  />
        </div>
